...
fun RemindSection(
    ...
    val soundStringChoices = remember { mapOf(
    ...
    val soundIconChoices = remember { mapOf(
    ...
    val vibrateStringChoices = remember { mapOf(
    ...
    val vibrateIconChoices = remember { mapOf(
